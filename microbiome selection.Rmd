...
library(nlme)
library(effects)
library(sjPlot) #  mixed effects table summary https://strengejacke.wordpress.com/2015/06/05/beautiful-table-outputs-summarizing-mixed-effects-models-rstats/
